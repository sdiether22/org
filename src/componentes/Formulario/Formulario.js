...
const Formulario = (props) => {
    ...
    const [color, acutalizarColor] = useState("")

    const{registrarColaborador}=props
    const{crearEquipo}=props

    const manejarEnvio = (e) =>{
        e.preventDefault()//Evitamos que se recargue la pagina, cada que se haga un evento no requiere refrescar la pagina completa
    ...
    return <section className="formulario">
        ...
        <form onSubmit={manejarNuevoEquipo}>
            ...
            <Campo titulo="Color" placeholder="Ingresar el color en Hex" required valor={color} actualizarValor={acutalizarColor} type="color"/>
